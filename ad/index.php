...
if(!isset($_GET["title"])){
  ...
  $database = new Database();
	$category = $_GET["title"];
  $sql = "SELECT * FROM categories WHERE categories.name = '$category'";
...
<script>
  ...
  click: function(score, evt){
    $.ajax({
      method: "POST",
      url: "../php/allrequests.php?saverating",
      data: {'rating': score, 'product_id': '<?php echo $category_id; ?>'},
      success : function(data){
        if(data == "Success"){
          $('.starrr').html("<div class=\"text-center\">Thanks for your review on this product!.</div>");
        }
          if(data == "rated"){
            $('.starrr').html("<div class=\"text-center\">You have rated this product already!.</div>");
          }
          if(data == "fail"){
            $('.starrr').html("<div class=\"text-center\">You have to login first!. <a href=\"../auth/?login\" class=\"underline text-blue-500\">Login Here</a></div>");
          }
