...
if(!isset($_SESSION["user_id"])){
  ...
  $date = $_SESSION["joined_date"];
  if(strlen(date("j", $date) > 1)){
    $day = date("j", $date);
  }else{
    $day = date("0j", $date);
  }
  ...
  if($row = mysqli_fetch_assoc($query)){
    ...
    if(empty($dp)){
      $dp = "../images/user/user-thumb.png";
    }
  }
  $joined_date = date("$day F, Y");
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="sidebar">
          ...
          <div class="widget user-dashboard-profile">
            ...
            <div class="profile-thumb">
              <img src="<?php echo $dp; ?>" alt="" class="rounded-circle">
            </div>
            <!-- User Name -->
            <h5 class="text-center"><?php echo $_SESSION["user_firstname"]." ".$_SESSION["user_lastname"]?></h5>
