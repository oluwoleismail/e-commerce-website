			...
			<div class="col-md-12">
				<nav class="navbar navbar-expand-lg navbar-light navigation">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul class="navbar-nav ml-auto md:mt-10 mt-0">
							<?php 
							if(isset($_SESSION["user_id"])){
								echo '<li class="nav-item">
									...
									<li class="nav-item">
								<a class="nav-link text-white add-button" href="post-ad/"><i class="fa fa-plus-circle"></i> Add Listing</a>
							</li>';
							}
							else{
								echo '<li class="nav-item">
					...
					<div class="short-popular-category-list text-center">
						...
						<ul class="list-inline">
							<li class="list-inline-item m-2">
								<a href="category/?category=hotel"><i class="fa fa-bed"></i> Hotel</a></li>
							<li class="list-inline-item m-2">
								<a href="category/?category=fitness"><i class="fa fa-grav"></i> Fitness</a>
							</li>
							<li class="list-inline-item m-2">
								<a href="category/?category=cars"><i class="fa fa-car"></i> Cars</a>
							</li>
							<li class="list-inline-item m-2">
								<a href="category/?category=restaurants"><i class="fa fa-cutlery"></i> Restaurants</a>
							</li>
							<li class="list-inline-item m-2">
								<a href="category/?category=cafe"><i class="fa fa-coffee"></i> Cafe</a>
							</li>
						</ul>
					</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="section-title">
					<h2>Trending Ads</h2>
					<p>Check out latest trending ads</p>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-8">
				<div class="content-holder">
					...
					<ul class="list-inline mt-30">
						<li class="list-inline-item"><a class="btn btn-main" href="ad-listing.html">Ad Listing</a></li>
      ...
      <div class="col-lg-4 col-md-7">
        ...
        <div class="block-2 app-promotion">
          <div class="mobile d-flex">
            ...
            <p>Get the Deals Mobile App and Save more</p>
          </div>
...
<script>
	$(".product-ratings").raty({ readOnly: true });
</script>
